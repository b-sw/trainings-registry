...
const Standings = () => {
    ...
    const cyclingRanking = [...users].sort(
        (a, b) => b.cyclingDistance - a.cyclingDistance
    )
    const runningRanking = [...users].sort(
        (a, b) => b.runningDistance - a.runningDistance
    )
    const otherRanking = [...users].sort(
        (a, b) => b.otherDistance - a.otherDistance
    )
