...
const Home = () => {
    return (
        <div className="page">
            ...
            <p>
                Discover and manage professional training courses and
                certifications. Our comprehensive registry helps you find the
                right training programs to advance your career and skills.
            </p>
