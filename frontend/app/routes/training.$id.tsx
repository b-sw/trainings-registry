...
const trainingsData = [
    ...
    },
    {
        ...
        description: 'Design and implement cloud solutions using Amazon Web Services.',
        duration: '56 hours',
        level: 'Advanced',
    ...
    return (
        <div className="page">
            <div style={{ marginBottom: '1rem' }}>
                <Link to="/trainings" style={{ color: '#2563eb', textDecoration: 'none' }}>
                    ← Back to Trainings
                </Link>
            </div>
            ...
            >
                ...
                >
                    <h3 style={{ marginBottom: '1rem', color: '#1e293b' }}>Course Details</h3>
